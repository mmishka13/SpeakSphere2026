...
export default function AuthPage() {
  const [mode, setMode]       = useState("signup"); // signup | login | exam | result
          ...
          <div style={p.formCard} className="card-enter" ref={cardRef}>
            ...
            {mode==="login" ? (
              <>
                ...
                <form onSubmit={e=>{e.preventDefault();alert("Firebase login here");}} noValidate>
  ...
  if(mode==="result") return (
    <div style={r.root}>
      ...
      <div style={r.card} className="card-enter">
        ...
        <button style={{ ...p.submitBtn, maxWidth:360, margin:"0 auto" }} onClick={()=>alert(`Welcome, ${form.name}! Navigate to /dashboard here.`)}>
